...
export default function CV() {
  ...
  const content = {
    zh: {
      ...
      robloxDesc:
        "獨立開發多個遊戲專案，累計獲得超過 300 美元和10萬Robux收益。",
      personalSite: "個人網站開發",
    ...
    <div className="min-h-screen py-8">
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mb-6 flex justify-between">
          ...
          <button
            onClick={handlePrint}
            className="rounded-full bg-neutral-900 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-neutral-800 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200"
          >
        ...
        <div
          ref={componentRef}
          className="rounded-lg bg-white p-8 shadow-lg dark:bg-neutral-900"
        >
          ...
          <section className="mb-6">
            ...
            <div className="space-y-2 text-neutral-700 dark:text-neutral-300">
              ...
              <p>
                <a
                  href="mailto:hhgg12661@gmail.com"
          ...
          <section className="mb-6">
            ...
            <div className="space-y-2 text-neutral-700 dark:text-neutral-300">
              ...
              <p>
                <strong>{content[language].gameDev}:</strong> Roblox Studio,
                Lua, Game Logic Design, UI/UX Design
              </p>
              <p>
